...
class ScratchCard extends Component {
    ...
    getMouse(e, canvas) {
        ...
        let {xScale, yScale} = this.getScale();
        return { x: mx*xScale, y: my*yScale }
    }
    getScale() {
        let xScale = 1 - 0.7 * (document.body.clientWidth - 375) / (1024 - 375);
        let yScale = 1 - 0.7 * (window.innerHeight - 667) / (1366 - 667);
    ...
    render() {
        ...
        return (
            <div className="ScratchCard__Container" style={Object.assign(containerStyle,style)}>
